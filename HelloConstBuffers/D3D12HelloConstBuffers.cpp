...
std::wstring D3D12HelloConstBuffers::GetAssetFullPath(LPCWSTR assetName)
{
...
_Use_decl_annotations_ void D3D12HelloConstBuffers::GetHardwareAdapter(IDXGIFactory2 *pFactory, IDXGIAdapter1 **ppAdapter)
{
